...
df=pd.read_csv('data/model1DSRL.csv')
tdf=pd.read_csv('data/model1DS_real.csv')
...
Y_pred=model.predict(rX)
save=pd.DataFrame(Y_pred)
save.to_csv('sm.csv')


#Y_pred3=model3.predict(X_test)
#print(mean_squared_error(Y_test,Y_pred),mean_squared_error(Y_test,Y_pred3) )
